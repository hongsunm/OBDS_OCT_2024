...
fastqc  --nogroup --threads 1 --extract -o \
/project/shug6597/1_linux/rnaseq/fastqc_slurm_exercise \
/project/shug6597/1_linux/rnaseq/fastq/*.fastq.gz

#It is easier to just run the multiqc in terminal
# multiqc /project/shug6597/1_linux/rnaseq/fastqc_slurm_exercise \
# -f -n my_multiqc.html
